      ...
      <section id="compare" className="w-full">
        <div className="compare-wrapper">
          <div className="compare-text-wrapper">
            ...
            <p>Forget about spending hours writting. Let us do the heavy lifting.</p>
          </div>

          <div className="before-container">
            <h3 className="compare-title">Writting should not drain your energy.</h3>
            <ul className="compare-list">
              <li>Stop wasting hours writting.</li>
              <li>You lose ideas before noting them.</li>
              <li>Writting posts is tiring.</li>
          ...
          <div className="after-container">
            ...
            <ul className="compare-list">
              ...
              <li>Writting posts is effortless.</li>
